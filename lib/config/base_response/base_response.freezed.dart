...
class Success<T> implements BaseResponse<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $BaseResponseCopyWith<T, $Res> {
...
class Failure<T> implements BaseResponse<T> {
...
@override
String toString() {
  return 'BaseResponse<$T>.failure(errorHandler: $errorHandler)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $BaseResponseCopyWith<T, $Res> {
