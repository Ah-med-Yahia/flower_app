...
import 'package:flower_app/features/categories/presentation/views/widgets/category_product_info_widget.dart';
...
class CategoryProductCardWidget extends StatelessWidget {
  ...
  const CategoryProductCardWidget({required this.product, super.key});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            8.verticalSpacing,
            Expanded(child: CategoryProductInfoWidget(product: product)),
            SizedBox(
              width: double.infinity,
