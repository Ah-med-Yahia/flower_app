...
class _VerifyOtpBodyState extends State<VerifyOtpBody> {
  ...
  void _listenToEvents() {
    ...
    widget.cubit.stream.listen((state) {
      ...
      debugPrint(
        '📊 State changed - isLoading: ${state.verifyOtpCodeState.isLoading}, error: ${state.verifyOtpCodeState.errorMessage}, data: ${state.verifyOtpCodeState.data}',
      );
      ...
      if (currentError != null && currentError != _lastErrorMessage) {
        ...
        debugPrint('❌ Showing error toast: $currentError');
