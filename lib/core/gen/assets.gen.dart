...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/circle_avatar.jpg
  AssetGenImage get circleAvatar =>
      const AssetGenImage('assets/images/circle_avatar.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [circleAvatar];
}
...
class $AssetsLottieGen {
  ...
  /// List of all assets
  List<LottieGenImage> get values => [flowerLoading];
}
