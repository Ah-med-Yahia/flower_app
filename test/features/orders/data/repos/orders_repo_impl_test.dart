...
void main() {
  ...
  group('get user orders repo implementaion test cases', () {
    test(
      'should return OrdersResponseEntity when data source returns successful response',
      () async {
        ...
        expect(success.data.orders, hasLength(mockResponse.orders!.length));
        expect(success.data.orders!.first.orderNumber, 'ORD-2024-0001');
