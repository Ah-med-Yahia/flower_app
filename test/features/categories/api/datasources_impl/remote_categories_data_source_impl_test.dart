...
void main() {
  ...
  group(
    ...
    () {
      _testGetAllCategoriesSuccessCase(dataSource, mockApiClient);
      _testGetAllCategoriesFailureCase(dataSource, mockApiClient);
    },
  );
}

void _testGetAllCategoriesSuccessCase(
  RemoteCategoriesDataSourceImpl dataSource,
  MockCategoriesApiClient mockApiClient,
) {
