...
- **Product Discovery**: Browse a wide variety of flowers with detailed descriptions.
- **Categories**: Filter products by categories to find exactly what you need.
...
This project is built using **Flutter** and follows **Clean Architecture** principles.
